...
<main class="flex-1 flex flex-col bg-white overflow-hidden">
  ...
  <div class="py-4 flex-1 overflow-y-scroll" role="list">
    <div
      class="flex items-start px-6 py-2 text-sm hover-target hover:bg-grey-lightest"
      role="listitem"
    >
      ...
      <div class="flex-1">
        <h5 class="text-sm">
          ...
          <time class="text-grey-darker text-xs font-normal"
            >Apr 21, 2019 12:21.38 PM</time
          >
        </h5>
